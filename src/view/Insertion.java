...
import controller.GuiMethods;
import javax.swing.JOptionPane;
import model.InsertDB;

public class Insertion extends javax.swing.JFrame {

    InsertDB dm2 = InsertDB.getInstance();

    public Insertion() {
        initComponents();
        Advanced.closeWindow(this);
...
//        if (evt.getClickCount() == 2) {
        GuiMethods.getPath(this, path);
//        }
    }//GEN-LAST:event_pathMouseClicked

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (path.getText().isEmpty()) {
            JOptionPane.showMessageDialog(null, "بعض الحقول فارغه");
        } else {
            InsertDB.getInstance().insertImage(path.getText());
        }
